...
class UserPatchRequest(BaseModel):
    ...
    age: Optional[int] = Field(None, ge=1, le=120, description="The user's age")
    email: Optional[EmailStr] = Field(None, format='email', description="User's email")
    password: Optional[str] = Field(None, min_length=3, max_legth=15, description="User's password")
